# Megfigyelték, ahogy egy távoli fekete lyuk felfal egy csillagot

## Elképesztően ritka, hogy egy ilyet meg lehessen figyelni, főleg hogy az egy távoli galaxisban, 12,4 milliárd fényévre történt.
...
## Különböző hullámhosszakon végzett megfigyelések segítettek összerakni, hogy mi történt

A különleges, gyorsan felfényesedő majd elhalványuló, de összességében több mint 30 napig megfigyelhető AT2022cmc jelforrást észlelése után más obszervatóriumok is megfigyelték. 

Ezek közt volt a NASA [Neil Gehrels Swift obszervatórium](https://en.wikipedia.org/wiki/Neil_Gehrels_Swift_Observatory) űrtávcsöve, ami röntgen-tartományban vizsgálata, valamint az Új-Mexikóban található [Very Large Array](https://en.wikipedia.org/wiki/Very_Large_Array) rádiótávcső rendszer is. Az objektumok távolságát pedig az európai déli obszervatórium Nagyon Nagy Teleszkópja (VLT) segítségével [határozták meg](https://www.eso.org/public/news/eso2216/).
...
A jel tulajdonságai alapján a legvalószínűbb forgatókönyv szerintük az, hogy egy távoli galaxis középpontjában található fekete lyukból indult ki, és a galaxisban található por nem takarja el a jelet előlünk. A kutatók kiszámolták az ilyen események gyakoriságát, aminél korrigáltak arra, hogy azokból csak a felénk irányulókat észleljük. Arra jutottak, hogy ezek elég ritkák, az ár-apályos szétszakítási eseményeknek ugyanis csak 1 százaléka eredményez relativisztikus nyalábokat.

## Naphoz hasonló csillagot falt fel a fekete lyuk
...
https://qubit.hu/2022/05/12/megerkezett-a-szenzacios-elso-felvetel-a-tejutrendszer-kozponti-fekete-lyukarol
